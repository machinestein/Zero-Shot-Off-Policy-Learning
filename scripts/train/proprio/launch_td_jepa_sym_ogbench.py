...
if __name__ == "__main__":
    ...
    main(args)
    # uv run -m scripts.train.proprio.launch_td_jepa_sym_ogbench --use_wandb --wandb_gname td_jepa_sym_antmaze_proprio --data_path datasets --workdir_root results --sweep_config sweep_antmaze
    # uv run -m scripts.train.proprio.launch_td_jepa_sym_ogbench --use_wandb --wandb_gname td_jepa_sym_cube_proprio --data_path datasets --workdir_root results --sweep_config sweep_cube
