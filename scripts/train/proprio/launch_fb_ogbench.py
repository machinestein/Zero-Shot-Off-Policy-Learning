...
class LaunchArgs:
    ...
    data_path: str = "/home/jovyan/bobrin/td_jepa/ogbench_data"
...
if __name__ == "__main__":
    ...
    main(args)
    # uv run -m scripts.train.proprio.launch_fb_ogbench --use_wandb --wandb_gname fb_antmaze_proprio --data_path ogbench_data --workdir_root results --sweep_config sweep_antmaze
    # uv run -m scripts.train.proprio.launch_fb_ogbench --use_wandb --wandb_gname fb_cube_proprio --data_path ogbench_data --workdir_root results --sweep_config sweep_cube
