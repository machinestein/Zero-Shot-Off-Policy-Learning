...
from metamotivo.misc.launcher_utils import all_combinations_of_nested_dicts_for_sweep, flatten, launch_trials, setup_wandb_config, unflatten
            ...
            flatten(
                {
                    **setup_wandb_config(
                    ...
                    "work_dir": f"{args.workdir_root}/{trial['env.domain']}/{i}",
...
if __name__ == "__main__":
    ...
    main(args)
    # uv run -m scripts.train.proprio.launch_sf_ogbench --use_wandb --wandb_gname byol_antmaze_proprio --data_path datasets --workdir_root results --sweep_config sweep_byol_antmaze --sf_agent byol
    # uv run -m scripts.train.proprio.launch_sf_ogbench --use_wandb --wandb_gname byol_cube_proprio --data_path datasets --workdir_root results --sweep_config sweep_byol_cube --sf_agent byol

    # uv run -m scripts.train.proprio.launch_sf_ogbench --use_wandb --wandb_gname byol_gamma_antmaze_proprio --data_path datasets --workdir_root results --sweep_config sweep_byol_antmaze --sf_agent byol-gamma
    # uv run -m scripts.train.proprio.launch_sf_ogbench --use_wandb --wandb_gname byol_gamma_cube_proprio --data_path datasets --workdir_root results --sweep_config sweep_byol_cube --sf_agent byol-gamma

    # uv run -m scripts.train.proprio.launch_sf_ogbench --use_wandb --wandb_gname hilp_antmaze_proprio --data_path datasets --workdir_root results --sweep_config sweep_hilp_antmaze --sf_agent hilp
    # uv run -m scripts.train.proprio.launch_sf_ogbench --use_wandb --wandb_gname hilp_cube_proprio --data_path datasets --workdir_root results --sweep_config sweep_hilp_cube --sf_agent hilp

    # uv run -m scripts.train.proprio.launch_sf_ogbench --use_wandb --wandb_gname laplacian_antmaze_proprio --data_path datasets --workdir_root results --sweep_config sweep_laplacian_antmaze --sf_agent laplacian
    # uv run -m scripts.train.proprio.launch_sf_ogbench --use_wandb --wandb_gname laplacian_cube_proprio --data_path datasets --workdir_root results --sweep_config sweep_laplacian_cube --sf_agent laplacian

    # uv run -m scripts.train.proprio.launch_sf_ogbench --use_wandb --wandb_gname icvf_antmaze_proprio --data_path datasets --workdir_root results --sweep_config sweep_hilp_antmaze --sf_agent icvf
    # uv run -m scripts.train.proprio.launch_sf_ogbench --use_wandb --wandb_gname icvf_cube_proprio --data_path datasets --workdir_root results --sweep_config sweep_hilp_cube --sf_agent icvf
